...
public class Turret : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            Vector3 l_euler = Quaternion.RotateTowards(m_tfGunBody.rotation, t_lookRotation, m_spinSpeed * Time.deltaTime).eulerAngles;
            m_tfGunBody.rotation = Quaternion.Euler(0, l_euler.y, 0);
